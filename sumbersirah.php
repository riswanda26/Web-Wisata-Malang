 ...
 <div class="navbar-fixed">
  ...
  <div id="index-banner">
    <div class="section no-pad-bot" >
      <div class="container">
        <h2 class="center blue-text"><strong> SUMBER SIRAH </strong></h2>
        <!-- gambar pantai -->
		<center><img src="gambar/new/Air/sirah.jpg"></center>
        <!-- end gambar -->
      </div>
    </div>
  </div>
      ...
      <div id="hal1" class="col s12">
        <div class="container">
          <h3 class="blue-text center">INFO WISATA</h3>
            <p align="center">
		  <br>- S U M B E R S I R A H -</p>
		  <p align="justify">
			Sumber Sirah merupakan wisata pemandian air yang terletak di Gondanglegi, Malang. Wisata Air Sumber Sirah terkenal karena pemandangan indah dibawah airnya karena dapat melihat tumbuhan-tumbuhan yang masih terawat di dalam air. Selaian itu, air di Sumber Sirah sangatlah segar karena terjaga kealamiannya.
		  </p>
                    ...
                    <div><center><h3></h3></center></div>
                      ...
                      <div class="input-field col s12">
                       ...
                       <div class="input-field col s12">
                        ...
                        <br>
                        <br>
                        <select name="Kamera" class="browser-default" required>
