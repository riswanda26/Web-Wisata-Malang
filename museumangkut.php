 ...
 <div class="navbar-fixed">
  ...
  <div id="index-banner">
    <div class="section no-pad-bot" >
      <div class="container">
        <h2 class="center blue-text"><strong>MUSEUM ANGKUT</strong></h2>
        <!-- gambar pantai -->
		<center><img src="gambar/new/Edukasi/angkut.jpg"></center>
        <!-- end gambar -->
      </div>
    </div>
  </div>
      ...
      <div id="hal1" class="col s12">
        <div class="container">
          <h3 class="blue-text center">INFO WISATA</h3>
            <p align="center">
		  <br>- M U S E U M A N G K U T -</p>
		  <p align="justify">
			Museum Angkut merupakan tempat wisata edukasi yang sangat bagus untuk tempat berfoto-foto. Museum Angkut menyediakan berbagai macam benda dan tempat yang menjadi ciri khas di luar negeri. Tempat yang luas dan penataan yang bagus menjadikan museum angkut tempat yang sangat untuk liburan keluarga baik anak-anak ataupun orang dewasa.
           <p align="center">Info Harga Tiket dan Fasisilitas
		  <br>Harga Weekend   : Rp.70.000
		  <br>Harga Weekday   : Rp.100.000
		  <br>Persewaan Guide : Rp. 50.000/guide
		  <br>Persewaan Bus   : Rp. 1.000.000/bus
          <br>Persewaan Kamera: Rp. 50.000/hari
		  <br>
		  <br>
		  </p>
        </div>
                ...
                <form action="<?php $_SERVER['PHP_SELF'];?>" method="POST" class="col s6 push-s3">
                  <div class="row">
                    <div><center><h3></h3></center></div>
                      ...
                      <div class="input-field col s12">
                        <label>K a m e r a</label>
                        <br>
                        <br>
                        <select name="RKamera" class="browser-default" required>
                          <option value="" disabled selected>Choose your option </option>
                          <option value="Tanpa Kamera" >Tanpa Kamera</option>
                          <option value="Kamera DSLR" >Kamera DSLR</option>
                          <option value="Kamera Xiaomi Yi" >Kamera Xiaomi Yi</option>
      ...
      <div id="hal3" class="col s12">
        <div class="container">
          ...
          ?>
                    ...
                    <li class="black-text"><?php echo $_POST['Kamera'] ;?></li><br/>
