 ...
 <div class="navbar-fixed">
  ...
  <div id="index-banner">
    <div class="section no-pad-bot" >
      <div class="container">
        <h2 class="center blue-text"><strong> PANTAI BALEKAMBANG </strong></h2>
        <!-- gambar pantai -->
		<center><img src="gambar/new/Pantai/balekambang.jpg"></center>
        <!-- end gambar -->
      </div>
    </div>
  </div>
      ...
      <div id="hal1" class="col s12">
        <div class="container">
          <h3 class="blue-text center">INFO WISATA</h3>
            <p align="center">
		  <br>- P A N T A I  B A L E K A M B A N G -</p>
		  <p align="justify">
			Pantai Balekambang Malang merupakan tempat wisata pantai sekaligus religi bagi semua kalangan, mulai dari anak-anak hingga orang dewasa. Di Pantai Balekambang terdapat sebuah wihara untuk tempat beribadah dan untuk tempat melakukan upacara adat. Di Pantai Balekambang tidak hanya pantainya saja yang indah dengan lautan yang biru, namun ciri khas jembatan menuju wihara di Pantai Balekambang menjadi ciro khas tersendiri dibanding pantai-pantai lainnya di wilayah Malang Raya.
           <p align="center">Info Harga Tiket dan Fasisilitas
		  <br>Harga Weekend   : Rp.6.000
		  <br>Harga Weekday   : Rp.10.000
