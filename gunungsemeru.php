 ...
 <div class="navbar-fixed">
  ...
  <div id="index-banner">
    <div class="section no-pad-bot" >
      <div class="container">
        <h2 class="center blue-text"><strong> PUNCAK GUNUNG SEMERU </strong></h2>
        <!-- gambar pantai -->
		<center><img src="gambar/new/Gunung/semeruu.jpg"></center>
        <!-- end gambar -->
      </div>
    </div>
  </div>
      ...
      <div id="hal1" class="col s12">
        <div class="container">
          <h3 class="blue-text center">INFO WISATA</h3>
            <p align="center">
		  <br>- G U N U N G    S E M E R U -</p>
		  <p align="justify">
			Gunung Semeru merupakan tempat wisata alam yang merupakan gunung tertinggi di Jawa Timur. Untuk menuju ke Gunung Semeru harus melakukan pendakian dan berkemah di Gunung Semeru. Selain menuju ke puncak Gunung Semeru, anda juga bisa menikmati keindahan Ranu Kumbolo yang merupakan danau alami yang terletak di kaki Gunung Semeru. 
		  </p>
           <p align="center">Info Harga Tiket dan Fasisilitas
		  <br>Harga Weekend   : Rp.17.500
		  <br>Harga Weekday   : Rp.22.500
		  <br>Persewaan Tenda : Rp. 50.000/tenda
		  <br>Persewaan Jeep  : Rp. 500.000/jeep
		  <br>
		  </p>
        </div>
      </div>
                    ...
                    <div><center><h3></h3></center></div>
                      ...
                      <div class="input-field col s12">
                       ...
                       <div class="input-field col s12">
                        ...
                        <br>
                        <br>
                        <select name="Jeep" class="browser-default" required>
                          <option value="" disabled selected>Choose your option </option>
                          <option value="Tanpa Jeep" >Tanpa Jeep</option>
                          <option value="Pesan Jeep" >Pesan Jeep</option>
                        ...
                        <select name="Tenda" class="browser-default" required>
                          ...
                          <option value="Pesan Tenda" >Pesan Tenda</option>
      ...
      <div id="hal3" class="col s12">
        <div class="container">
          ...
          ?>
                    ...
                    <li class="black-text"><?php echo $_POST['Jeep'] ;?></li><br/>
